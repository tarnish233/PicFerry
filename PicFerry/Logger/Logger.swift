...
public final class Logger: @unchecked Sendable {
    ...
    public func verbose(_ message: Any,
                        ...
                        line: UInt = #line) {
        DDLogVerbose("\(String(describing: message))", file: file, function: function, line: line)
    }
    ...
    public func debug(_ message: Any,
                      ...
                      function: StaticString = #function,
                      line: UInt = #line) {
        DDLogDebug("\(String(describing: message))", file: file, function: function, line: line)
    }
    ...
    public func info(_ message: Any,
                     ...
                     function: StaticString = #function,
                     line: UInt = #line) {
        DDLogInfo("\(String(describing: message))", file: file, function: function, line: line)
    }
    ...
    public func warn(_ message: Any,
                     ...
                     function: StaticString = #function,
                     line: UInt = #line) {
        DDLogWarn("\(String(describing: message))", file: file, function: function, line: line)
    }
    ...
    public func error(_ message: Any,
                      ...
                      function: StaticString = #function,
                      line: UInt = #line) {
        DDLogError("\(String(describing: message))", file: file, function: function, line: line)
    }
