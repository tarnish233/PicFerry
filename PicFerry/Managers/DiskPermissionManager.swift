...
@MainActor
public final class DiskPermissionManager {
    
    // static
    public static let shared = DiskPermissionManager()
    ...
    private func shouldUseRootSubdirectoryWorkaround() -> Bool {
        ...
        // macOS 26.0 需要使用临时解决方案，26.1 及以后使用根目录授权。
        return osVersion.majorVersion == 26 && osVersion.minorVersion == 0
    }
